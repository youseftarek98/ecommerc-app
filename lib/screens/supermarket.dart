                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              Consumer<Favorite>(builder: (context , favor , child){
                                                                return Container(
                                                                  child: IconButton(onPressed: (){
                                                                    favor.added(listModel[13]) ;
                                                                    favor.listItems() ;
                                                                    favor.checkIfProductInCarts(listModel[13]);
                                                              ...
                                                              ElevatedButton(
                                                                onPressed: () {
                                                                  cartItemPage.checkIfProductInCart(listModel[13]);
                                                                  cartItemPage.listItem() ;
                                                                  cartItemPage.add(listModel[13]);
                                                                },
                                                                child: Text(
                                                                  "Add to Cart",
                                                                  style: TextStyle(
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              Consumer<Favorite>(builder: (context , favor , child){
                                                                return Container(
                                                                  child: IconButton(onPressed: (){
                                                                    favor.added(listModel[14]) ;
                                                                    favor.listItems() ;
                                                                    favor.checkIfProductInCarts(listModel[14]);
                                                                  }, icon: Icon(Icons.favorite_border)),
                                                                );
                                                              }),
                                                              ...
                                                              ElevatedButton(
                                                                onPressed: () {
                                                                  cartItemPage.checkIfProductInCart(listModel[14]);
                                                                  cartItemPage.listItem() ;
                                                                  cartItemPage.add(listModel[14]);
                                                                },
                                                                child: Text(
                                                                  "Add to Cart",
                                                                  style: TextStyle(
